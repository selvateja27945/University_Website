...
<body>
	...
	<div align="center">
		<h1>Freedom to Search your choice.</h1>
	</div>

	<div align="center">
		<form name="eventsearch" action="/searchevents" method="post">
		...
		<c:if test="${events.size()==0 }">No Events Available</c:if>
		<c:if test="${events.size() > 0 }">
			<h1><i>List of Event Details</i></h1>
			<table>
				<tr>
					<th>Event Id</th>
					<th>Event Name</th>
				...
				<c:forEach items="${events }" var="list">
					<tr>
						<td>${list.eventId }</td>
